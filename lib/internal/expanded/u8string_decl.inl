...
#define CSTL_string_bufsize (16 / sizeof(char8_t) < 1 ? 1 : 16 / sizeof(char8_t))
// roundup mask for allocated buffers, [0, 15]
#define CSTL_string_alloc_mask (sizeof(char8_t) <= 1 ? 15 \
                              : sizeof(char8_t) <= 2 ? 7  \
                              : sizeof(char8_t) <= 4 ? 3  \
                              : sizeof(char8_t) <= 8 ? 1  \
                                                         : 0)
 ...
 * 
 */
typedef const CSTL_UTF8StringVal* CSTL_UTF8StringCRef;
