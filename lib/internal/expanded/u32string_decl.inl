...
#define CSTL_string_bufsize (16 / sizeof(char32_t) < 1 ? 1 : 16 / sizeof(char32_t))
// roundup mask for allocated buffers, [0, 15]
#define CSTL_string_alloc_mask (sizeof(char32_t) <= 1 ? 15 \
                              : sizeof(char32_t) <= 2 ? 7  \
                              : sizeof(char32_t) <= 4 ? 3  \
                              : sizeof(char32_t) <= 8 ? 1  \
                                                         : 0)
 ...
 * 
 */
typedef struct CSTL_UTF32StringVal {
    union CSTL_UTF32StringUnion {
        char32_t buf[CSTL_string_bufsize];
        char32_t* ptr;
 ...
 * 
 */
typedef const CSTL_UTF32StringVal* CSTL_UTF32StringCRef;
